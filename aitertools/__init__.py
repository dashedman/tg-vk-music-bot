...
class AsyncISlice(typing.Generic[T], typing.AsyncIterator[T]):

    """Async version of the islice iterable."""

    def __init__(
            self,
            iterable: typing.Union[typing.Iterable[T], typing.AsyncIterable[T]],
            *args
    ):
    ...
    async def __anext__(self) -> T:
        ...
        if not self._initialized:
            ...
            self._iterable: typing.AsyncIterator[T] = await aiter(self._iterable)
            self._initialized = True
